...
export const CLI_APPS: Readonly<IAppSetup[]> = [
    ...
    },
    {
        ...
        tags: ['engineering'],
        openUrl: () => BREW_HOME('mongodb-community@8.0'),
        commands: () => [BREW_TAP('mongodb/brew'), BREW_INSTALL('mongodb-community@8.0'), 'mkdir -p "$HOME/mongodb"'],
        fallbackCommands: () => [
            BROW_TAP('mongodb/brew'),
            BROW_INSTALL('mongodb-community@8.0'),
    ...
    },
    {
        ...
        group: 'cli-apps',
        tags: ['engineering'],
        openUrl: () => BREW_HOME('jq'),
        commands: () => [BREW_INSTALL('jq')],
        fallbackCommands: () => [BROW_INSTALL('jq')],
    },
    {
        name: 'mas',
        ...
        group: 'cli-apps',
        tags: ['super-user'],
        openUrl: () => BREW_HOME('mas'),
        commands: () => [BREW_INSTALL('mas')],
        fallbackCommands: () => [BROW_INSTALL('mas')],
    },
] as const
